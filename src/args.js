...
module.exports = yargs
  ...
  .option('failOn', {
    description: 'fail (exit with code 1) if any package license does not satisfies the value',
    type: 'string'
  })
  .option('generateOutputOn', {
    description: 'generates an output file only if any package has a license that satisfies the value (output generated by default).',
    type: 'string'
  })
